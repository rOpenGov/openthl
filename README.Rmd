...
See the Articles section at the [package homepage](http://ropengov.github.io/openthl) for more.
...
**Kindly cite this work** as follows: Tuomo Nieminen and [Leo Lahti](https://github.com/antagomir). Retrieval and analysis of THL open data with the openthl package. R package version `r sessionInfo()$otherPkgs$openthl$Version`. URL: [http://ropengov.github.io/openthl](http://ropengov.github.io/openthl)

We are grateful to all [contributors](https://github.com/rOpenGov/openthl/graphs/contributors), and for [THL open data portal](https://thl.fi/en/web/thlfi-en/statistics/statistical-databases/open-data)! This project is part of [rOpenGov](http://ropengov.github.io).



[chat-badge]: https://img.shields.io/badge/chat-on%20gitter-46BC99.svg?style=flat-square
[chat]: https://gitter.im/ropengov/openthl?utm_source=badge&utm_medium=badge&utm_campaign=pr-badge&utm_content=badge
